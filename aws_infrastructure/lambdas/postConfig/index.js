...
exports.handler = async (event) => {
    ...
    let response;
    let sqlQuery = `INSERT INTO configs (name, title, summary, operating_mode, recipient_id, amount, start_dts, end_dts,
                                         created_dts, deactivated_dts, client_id)
                    VALUES ('${body.name}', '${body.title}', '${body.summary}', ${body.operating_mode},
                            '${body.recipient_id}', ${body.amount}, ${body.start_dts}, ${body.end_dts},
                            current_timestamp(), null, '${client_id}')`;
    try {
